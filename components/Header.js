...
export default function Header() {
  return (
    <header className="fixed top-0 h-20 w-screen flex flex-row items-center justify-between px-5 bg-slate-100 text-neutral-800 dark:bg-neutral-800 dark:text-orange-500 shadow-md shadow-neutral-200 dark:shadow-slate-500/20 z-50">
